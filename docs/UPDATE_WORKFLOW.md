...
- the Omniverse app definition,
- the custom extension source,
- the Rubin data-generation scripts,
- the preprocessing scripts,
- documentation.

Large generated or third-party assets should generally remain outside Git unless their redistribution and storage requirements are understood.

In particular, avoid committing large scheduler support data, caches, logs, generated databases, and unrelated local assets.
